...
function InputController:RequestSprint(enabled) Remotes.RequestSprint:FireServer(enabled == true) end
function InputController:RequestRest(enabled) Remotes.RequestRest:FireServer(enabled == true) end
