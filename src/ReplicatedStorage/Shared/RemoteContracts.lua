local RemoteContracts = {
    ...
    StatUpdate = { Direction = "ServerToClient", Payload = { "health", "hunger", "thirst", "stamina", "oxygen", "maxOxygen", "growth", "growthStage", "diet", "species", "creatureCategory", "swimming", "flying", "movementModes", "ecosystemProfile", "statusEffects" } },
