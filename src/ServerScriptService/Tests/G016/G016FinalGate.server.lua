...
require(script.Parent.G016FinalGateSuite)

local results = TestRunner.run({ category = "G016FinalGate", milestone = "G016FinalGate" })
...
if results.failed > 0 then
    ...
    error("G016FinalGate failed: " .. table.concat(messages, " | "), 0)
end
