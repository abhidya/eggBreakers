...
UserStoryTestRegistry.Stories = {
    ...
    { id = "US06", title = "Movement, eating, rest, age, and growth live loop works", required = { "Unit", "Integration", "E2E", "Client", "Live" }, liveProof = "US06LiveProofPassed" },
    ...
    { id = "US12", title = "Readable dying state, death, and respawn persistence work", required = { "Unit", "Integration", "E2E", "Client", "Live" }, liveProof = "US12LiveProofPassed" },
