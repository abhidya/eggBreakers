...
function G016LiveProofHarness:Run(options)
    ...
    local ok, resultOrErr = pcall(function()
        ...
        nest.Transparency = 0
        nest:SetAttribute("CreatorStoreOnly", nil)
        nest:SetAttribute("ImportedVisibleAsset", nil)
        nest:SetAttribute("AssetManifestId", nil)
        nest:SetAttribute("ProceduralGameplayVisual", true)
        ...
        setStoryProof(proof, "US11", "adult used visible nest affordance and received egg slot plus hatchling buff; release imported-nest honesty remains governed by US14", source, timestamp)
