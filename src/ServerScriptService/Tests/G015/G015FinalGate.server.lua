...
require(script.Parent.G015FinalGateSuite)

local results = TestRunner.run({ category = "G015FinalGate", milestone = "G015FinalGate" })
...
if results.failed > 0 then
    ...
    error("G015FinalGate failed: " .. table.concat(messages, " | "), 0)
end
