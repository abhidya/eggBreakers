...
local function setup(id,stage) local p=MockPlayer.new(id,"NestE2E"); RateLimitService:ClearPlayer(p); local s=SurvivalService:CreateState(p,"parasaurolophus"); s.Hatched=true; s.GrowthStage=stage; local r=Instance.new("Part"); r.Name="HumanoidRootPart"; r.Position=Vector3.new(0,3,0); local c=Instance.new("Model"); r.Parent=c; p.Character=c; local n=Instance.new("Part"); n.Position=Vector3.new(3,3,0); n.Parent=workspace; CollectionService:AddTag(n,"NestZone"); return p,n end
