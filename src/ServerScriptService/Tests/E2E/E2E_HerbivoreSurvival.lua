...
local function setup(id) local p=MockPlayer.new(id,"HerbE2E"); RateLimitService:ClearPlayer(p); local r=Instance.new("Part"); r.Name="HumanoidRootPart"; r.Position=Vector3.new(0,3,0); local c=Instance.new("Model"); r.Parent=c; p.Character=c; local s=SurvivalService:CreateState(p,"parasaurolophus"); s.Hatched=true; return p,s end
