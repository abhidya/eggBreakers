...
| Final G013 gate expected result | FAIL | `G013FinalGate.server.lua` is intentionally red until fallback visuals, pre-hatch drinking, pending-only combat, empty NPC models, placeholder carcasses, and materialized import count blockers are fixed. |
