...
| G018-US10 | Omnivore support allows plant and carcass food without weakening gates | PASS | FIXING | FAIL | N/A | FIXING | N/A | BLOCKED | FIXING | Remote validation accepts `Omnivore` for both food diets; no actual omnivore species/live proof yet. | Omnivore live/source integration proof |
