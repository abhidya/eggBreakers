...
| Actually Imported Assets | 58 live imported assets from Studio audit |
| Audited Imported Assets | 58 live assets marked script-audited; below target |
| Tagged Imported Assets | 58 live tagged imported assets; below target |
| Placed Visible Assets | 58 live placed/visible imported assets; below target |
| Release Ready Visible Assets | 58 live release-ready visible assets, below target |
| Script Objects Found | 0 in live imported visual roots during Studio audit |
| Scripts Quarantined | 0; no executable imported scripts found in the 58 live imported roots |
| Remaining Release Ready Gap To 500 | 442 |

Plan/manifest consistency audit: see `docs/G014/NextCreatorStoreAssetAudit.md`. The audit confirms G011 remains a 500-ID catalog, while G014 live materialization remains 58/500; post-catalog live imports are not manifest errors, and catalog-only rows are not counted as imported assets.
...
Added and organized 20 more Creator Store imports in open Studio. Live audit increased from 30/500 at session baseline to 58/500 release-ready visible assets; two inserted assets did not increase the unique release-ready count.
...
| Swamp bridge | 9016344250 | SwampDelta |
...
Live Studio audit after these batches: actuallyImportedAssets=58, auditedImportedAssets=58, taggedImportedAssets=58, placedVisibleAssets=58, releaseReadyVisibleAssets=58, scriptObjectsFound=0, scriptsQuarantined=0. Release validation still fails because the target is 500. Studio keyboard save attempt through MCP was rejected because `user_keyboard_input` is play-mode-only.
...
Live Studio audit after this batch: actuallyImportedAssets=58, auditedImportedAssets=58, taggedImportedAssets=58, placedVisibleAssets=58, releaseReadyVisibleAssets=58, scriptObjectsFound=0, scriptsQuarantined=0. Release validation still fails because the target is 500.
